...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_own_property_descriptor__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_define_property__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_create__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_core_js_json_stringify__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__ = __webpack_require__(4);
...
(function (root, factory) {
  ...
  } else if (( false ? 'undefined' : Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(module)) === 'object' && module.exports) {
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.extend = function (target) {
      ...
      for (i = 1; i < arguments.length; i++) {
        ...
        for (var prop in source) {
          ...
          if ((typeof sourceProp === 'undefined' ? 'undefined' : Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(sourceProp)) === 'object' && sourceProp !== null && !(sourceProp instanceof Array)) {
    ...
    Chartist.serialize = function (data) {
      if (data === null || data === undefined) {
        ...
        data = '' + data;
      } else if ((typeof data === 'undefined' ? 'undefined' : Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(data)) === 'object') {
        data = __WEBPACK_IMPORTED_MODULE_5_babel_runtime_core_js_json_stringify___default()({ data: data });
      }

      return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys___default()(Chartist.escapingMap).reduce(function (result, key) {
    ...
    Chartist.deserialize = function (data) {
      ...
      data = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys___default()(Chartist.escapingMap).reduce(function (result, key) {
    ...
    Chartist.safeHasProperty = function (object, property) {
      return object !== null && (typeof object === 'undefined' ? 'undefined' : Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(object)) === 'object' && object.hasOwnProperty(property);
    };
    ...
    Chartist.reverseData = function (data) {
      ...
      for (var i = 0; i < data.series.length; i++) {
        if (Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(data.series[i]) === 'object' && data.series[i].data !== undefined) {
    ...
    Chartist.isMultiValue = function (value) {
      return (typeof value === 'undefined' ? 'undefined' : Object(__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_typeof__["default"])(value)) === 'object' && ('x' in value || 'y' in value);
    };
  ...
  (function (window, document, Chartist) {
    ...
    function extend(properties, superProtoOverride) {
      ...
      var proto = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_create___default()(superProto);
      ...
      var constr = function constr() {
        ...
        instance = this === Chartist ? __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_create___default()(proto) : this;
    ...
    function cloneDefinitions() {
      ...
      args.splice(1, args.length - 1).forEach(function (source) {
        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_own_property_names___default()(source).forEach(function (propName) {
          delete target[propName];

          __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_define_property___default()(target, propName, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_own_property_descriptor___default()(source, propName));
        });
      });
  ...
  (function (window, document, Chartist) {
    ...
    function attr(attributes, ns) {
      ...
      __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys___default()(attributes).forEach(function (key) {
    ...
    function animate(animations, guided, eventEmitter) {
      ...
      __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys___default()(animations).forEach(function createAnimateForAttributes(attribute) {
    ...
    function SvgList(nodeList) {
      ...
      __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_keys___default()(Chartist.Svg.prototype).filter(function (prototypeProperty) {
