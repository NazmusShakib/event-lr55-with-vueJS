...
<body style="background-color: #F6F4EA">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{route('member.store')}}" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <label for="hh_address" class="input-sm">Address: City, State /
                                            Zip</label>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                    ...
                    <textarea name="sp_alt_address" id="sp_alt_address" cols="5" rows="3"
                              class="form-control input-sm"></textarea>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="hh_home_phone"
                                               name="hh_home_phone"
                                               size="30" type="text"/>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="sp_home_phone"
                                               name="sp_home_phone"
                                               size="30"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="hh_cell_phone"
                                               name="hh_cell_phone"
                                               size="30"
                                               type="text" required/>
                                    </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="sp_cell_phone"
                                               name="sp_cell_phone"
                                               size="30" type="text" required/>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="hh_work_phone"
                                               name="hh_work_phone"
                                               size="30" type="text"/>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="sp_work_phone"
                                               name="sp_work_phone"
                                               size="30"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <label for="hh_anniversary_date" class="input-sm">Anniversary
                                            Date</label>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="hh_occupation"
                                               name="hh_occupation"
                                               size="30" type="text"/>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="sp_occupation"
                                               name="sp_occupation"
                                               size="30"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <label for="hh_church_background" class="input-sm">Church
                                            Background</label>
                                    </div>
                                </div>
                                <div class='col-sm-4'>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class='form-group'>
                                        <label for="user_title" class="input-sm">Name (first, middle,
                                            last)</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child1_grade"
                                               name="child1_grade"
                                               size="7"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child1_class"
                                               name="child1_class"
                                               size="7"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child2_grade"
                                               name="child2_grade"
                                               size="7"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child2_class"
                                               name="child2_class"
                                               size="30"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child3_grade"
                                               name="child3_grade"
                                               size="7"
                                               type="text"/>
                                    </div>
                                ...
                                <div class='col-sm-2'>
                                    <div class='form-group'>
                                        <input class="form-control input-sm" id="child3_class"
                                               name="child3_class"
                                               size="7"
                                               type="text"/>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="hh_skill_administrator"
                                           id="hh_skill_administrator"
                                           value=true>
                                    <input type="checkbox" name="sp_skill_administrator"
                                           id="sp_skill_administrator"
                                           value=true>
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="hh_skill_artist" id="hh_skill_artist"
                                           value=true>
                                    <input type="checkbox" name="sp_skill_artist" id="sp_skill_artist"
                                           value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_skill_drama" id="hh_skill_drama"
                                               value=true>
                                        <input type="checkbox" name="sp_skill_drama" id="sp_skill_drama"
                                               value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_skill_electrical"
                                               id="hh_skill_electrical"
                                               value=true>
                                        <input type="checkbox" name="sp_skill_electrical"
                                               id="sp_skill_electrical"
                                               value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_skill_music" id="hh_skill_music"
                                               value=true>
                                        <input type="checkbox" name="sp_skill_music" id="sp_skill_music"
                                               value=true>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_pp_child_ministry"
                                               id="hh_pp_child_ministry"
                                               value=true>
                                        <input type="checkbox" name="sp_pp_child_ministry"
                                               id="sp_pp_child_ministry"
                                               value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_pp_finance" id="hh_pp_finance"
                                               value=true>
                                        <input type="checkbox" name="sp_pp_finance" id="sp_pp_finance"
                                               value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_pp_minister" id="hh_pp_minister"
                                               value=true>
                                        <input type="checkbox" name="sp_pp_minister" id="sp_pp_minister"
                                               value=true>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="hh_sf_administrations"
                                           id="hh_sf_administrations"
                                           value=true>
                                    <input type="checkbox" name="sp_sf_administrations"
                                           id="sp_sf_administrations"
                                           value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_sf_teaching" id="hh_sf_teaching"
                                               value=true>
                                        <input type="checkbox" name="sp_sf_teaching" id="sp_sf_teaching"
                                               value=true>
                                        <label class="input-sm">Teaching</label>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_sf_minister" id="hh_sf_minister"
                                               value=true>
                                        <input type="checkbox" name="sp_sf_minister" id="sp_sf_minister"
                                               value=true>
                                        <label class="input-sm">Minister</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="hh_sf_dvangelism" id="hh_sf_dvangelism"
                                           value=true>
                                    <input type="checkbox" name="sp_sf_dvangelism" id="sp_sf_dvangelism"
                                           value=true>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_ws_nursery" id="hh_ws_nursery"
                                               value=true>
                                        <input type="checkbox" name="sp_ws_nursery" id="sp_ws_nursery"
                                               value=true>
                                ...
                                <div class='col-sm-4'>
                                    <div class='form-group'>
                                        <input type="checkbox" name="hh_ws_teaching" id="hh_ws_teaching"
                                               value=true>
                                        <input type="checkbox" name="sp_ws_teaching" id="sp_ws_teaching"
                                               value=true>
                                        <label class="input-sm">Teaching</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="hh_ws_visitation" id="hh_ws_visitation"
                                           value=true>
                                    <input type="checkbox" name="sp_ws_visitation" id="sp_ws_visitation"
                                           value=true>
